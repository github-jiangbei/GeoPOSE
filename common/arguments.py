...
def parse_args():
    ...
    parser.add_argument('--geometry-tcn-blocks', default=4, type=int,
                        help='number of residual temporal blocks in the coarse TCN')
    parser.add_argument('--geometry-tcn-kernel', default=3, type=int,
                        help='temporal kernel size of the coarse TCN')
    parser.add_argument('--geometry-coarse-loss-weight', default=0.1, type=float,
                        help='auxiliary MPJPE loss weight for the coarse TCN pose')
    parser.add_argument('--geometry-default-root-depth', default=2.0, type=float,
                        help='fallback camera-space root depth when root trajectory is unavailable')
    parser.add_argument('--geometry-depth-scale', default=10.0, type=float,
    ...
    parser.add_argument('--adaptive-loss-max-scale', default=1.0, type=float,
                        help='maximum EMA scale for protective auxiliary-loss normalization; default does not amplify')
    ...
    parser.add_argument('--bone-direction-loss-weight', default=0.2, type=float,
                        help='relative weight for bone orientation consistency inside the bone loss')
